...
define('EMAIL_ADMIN_SUBJECT', 'Feedback letter from contacts form on Denver');
define('EMAIL_CLIENT_SUBJECT', 'Feedback letter from Denver');
...
<body>
	{$name_text}
	You sent a message to Denver administrators at {$datetime}.<br/><br/>
